...
import { formatAccountsSummary } from '../utils/accountsSummary';
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={async () => {
              try {
                await navigator.clipboard.writeText(formatAccountsSummary(accounts, netWorth));
                setCopied(true);
            ...
            className="px-3 py-2 bg-gray-800 rounded-xl text-gray-200 text-sm hover:text-white"
          >
            {copied ? 'Copied' : 'Copy'}
          </button>
          <button
            ...
            <div className="grid grid-cols-2 gap-2">
              {(['bank', 'cash', 'credit_card', 'wallet'] as AccountType[]).map((t) => (
                <button
                  key={t}
                  onClick={() => setType(t)}
                  className={`p-2 rounded-lg text-sm font-medium capitalize border ${
                    type === t
