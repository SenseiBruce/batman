...
import { formatGoalsSummary } from '../utils/goalsSummary';
      ...
      <div className="flex justify-between items-center mb-3 px-1">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={async () => {
              const text = formatGoalsSummary(goals, formatAmount);
              try {
      ...
      <div className="space-y-3">
        {goals.length === 0 && !isAdding ? (
          <div className="text-center py-8 bg-gray-800/50 rounded-xl border border-gray-700/50 border-dashed">
            ...
            <button onClick={() => setIsAdding(true)} className="mt-2 text-blue-400 text-sm">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      <AnimatedNumber value={goal.savedAmount} prefix={currencySymbol} /> /{' '}
