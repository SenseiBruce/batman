...
import { formatDailyInsight } from '../utils/dailyInsightSummary';
...
export const SmartInsightCard: React.FC<SmartInsightCardProps> = ({ insight }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl p-5 mb-6 bg-gradient-to-br ${insight.gradient} shadow-lg`}
    >
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mt-4 pt-3 border-t border-white/20">
          ...
          <button
            ...
            onClick={async () => {
              try {
                await navigator.clipboard.writeText(formatDailyInsight(insight));
                setCopied(true);
